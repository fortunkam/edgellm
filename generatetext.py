...
# model = LlamaCpp(model_path="./models/llama-2-7b.Q4_0.gguf", verbose=True, n_threads=8, n_gpu_layers=26)
model = LlamaCpp(model_path="./models/llama-2-7b.Q4_0.gguf", verbose=True, n_threads=4, n_gpu_layers=30)
